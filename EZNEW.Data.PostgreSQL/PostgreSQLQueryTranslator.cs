...
namespace EZNEW.Data.PostgreSQL
{
    ...
    public class PostgreSqlQueryTranslator : IQueryTranslator
    {
            ...
            foreach (var criterion in joinCriteria)
            {
                if (criterion is RegularJoinCriterion regularJoinCriterion)
                {
                    ...
                    else
                    {
                        ...
                        joinList.Add($"{criterionConnector}{joinFieldName} {sqlOperator} {PostgreSqlManager.ParameterPrefix}{parameterName}");
                    }
        ...
        string ConvertFieldName(IQuery query, string objectName, FieldInfo fieldInfo)
        {
            ...
            var fieldConversionResult = PostgreSqlManager.ConvertField(DatabaseServer, fieldInfo.ConversionOptions, objectName, fieldName);
